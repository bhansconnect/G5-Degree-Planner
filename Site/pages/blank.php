...
<!-- Sidebar -->
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="MechanicalEng.php">Mechanical Engineering</a>
                                </li>
                                <li>
                                    <a href="ElectricalEng.php">Electrical Engineering</a>
                                </li>
                                <li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="germanMinor.php">German</a>
                                </li>
                                <li>
                                    <a href="mathSciMinor.php">Mathematical Sciences</a>
                                </li>
                                <li>
                                    <a href="csMinor.php">Computer Science</a>
                                </li>
                                <li>
                                    <a href="microBioMinor.php">Microbiology</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                    ...
                    <!-- I'M LEAVING THIS IN IN CASE I WANT TO CHANGE ANYTHING TO MULTI LEVEL DROPDOWNS -->
                        <li>
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="blank.php">Test Page</a>
                                </li>
                                <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Tester</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
