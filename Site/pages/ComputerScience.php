            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
						...
						<a href="http://www.mtu.edu/cs/undergraduate/advising/pdfs/SCS2_2016_flowchart.pdf">Flowchart</a>
						<h2>Classes</h2>
						<?php
							require "mysql_connect.php";

							$sql ="SELECT course_name FROM courses WHERE dept='Computer Science'";
